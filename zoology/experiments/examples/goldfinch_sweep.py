...
for lr in np.logspace(-4, -2, 10):
    config = TrainConfig(
        ...
        model=ModelConfig(
            sequence_mixer=ModuleConfig(name='zoology.mixers.goldfinch.RWKV_Tmix_poco', kwargs={'l_max': 64}),
        ...
        logger=LoggerConfig(project_name='zoology_goldfinch_testing', entity='gpt6'),
        max_epochs=64,
