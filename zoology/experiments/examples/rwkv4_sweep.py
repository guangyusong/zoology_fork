...
for lr in np.logspace(-4, -2, 10):
    config = TrainConfig(
        ...
        model=ModelConfig(
            sequence_mixer=ModuleConfig(name='zoology.mixers.rwkv.RWKVTimeMixer', kwargs={'l_max': 64}),
        ...
        weight_decay=0.1,
        seed=123,
      #   launch_id='default-2024-01-11-22-44-01',
      #   sweep_id=None,
        run_id='rwkv-seqlen64-dmodel64-lr0.0001-kv4'
    )
