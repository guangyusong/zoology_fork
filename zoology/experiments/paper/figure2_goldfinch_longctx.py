...
for input_seq_len, num_kv_pairs in [
    ...
    if input_seq_len == 1024:
        ...
        batch_size = 512
    elif input_seq_len == 64:
        batch_size = 512
    elif input_seq_len == 2048:
        batch_size = 128 # H100 can almost handle 128 up to 256 but not 512
    elif input_seq_len == 4096:
        batch_size = 64
    elif input_seq_len == 8192:
        batch_size = 32
    elif input_seq_len == 16384:
        batch_size = 16
    elif input_seq_len == 32768:
        batch_size = 8
    elif input_seq_len == 65536:
        batch_size = 4
    elif input_seq_len == 131072:
        batch_size = 2
    elif input_seq_len == 262144:
        batch_size = 1
        ...
        for lr in  np.logspace(-4, -2, 4):
            ...
            for sequence_mixer in [
                ...
                config = TrainConfig(
                    ...
                    logger=LoggerConfig(
                        project_name="zoology-goldfinch-mqar-longctx",
                        entity="gpt6"
                    )
